    ...
    !function(t, e) {
        ...
        o = function() {
            ...
            return t.prototype.doScroll = function() {
                ...
                !f || t.vertical.oldScroll && t.vertical.newScroll || n[S]("refresh"),
                ...
                n.each(t, function(t, e) {
                    return n.each(i.waypoints[t], function(t, r) {
                        ...
                        (!r.options.onlyOnScroll || null == l) && r.enabled)
                            return null !== l && l < (s = e.oldScroll) && s <= r.offset ? r.trigger([e.backward]) : null !== l && l > (c = e.oldScroll) && c >= r.offset ? r.trigger([e.forward]) : null === l && e.oldScroll >= r.offset ? r.trigger([e.forward]) : void 0
                    })
                })
            }
            ,
            t.prototype.checkEmpty = function() {
                if (n.isEmptyObject(this.waypoints.horizontal) && n.isEmptyObject(this.waypoints.vertical))
                    return this.$element.unbind([p, v].join(" ")),
                    delete u[this.id]
            }
            ,
            t
        ...
        l = function() {
            ...
            t.prototype.destroy = function() {
                return delete s[this.axis][this.id],
            ...
            t.getWaypointsByElement = function(t) {
                var e, r;
                return (r = n(t).data(w)) ? (e = n.extend({}, s.horizontal, s.vertical),
                n.map(r, function(t) {
                    return e[t]
                })) : []
            }
        ...
        d = {
            init: function(t, e) {
                ...
                this.each(function() {
                    var t, r, i, s;
                    return t = n(this),
                    i = null != (s = e.context) ? s : n.fn[g].defaults.context,
        ...
        h = {
            ...
            aggregate: function(t) {
                var e, r, i;
                return e = s,
                t && (e = null != (i = u[n(t).data(a)]) ? i.waypoints : void 0),
                e ? (r = {
                    horizontal: [],
                    vertical: []
                },
            ...
            _invoke: function(t) {
                var e;
                return e = n.extend({}, s.vertical, s.horizontal),
