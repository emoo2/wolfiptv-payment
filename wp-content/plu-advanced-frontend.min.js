var _wapf = function(o) {
    var e, t, u = "wapf-", i = "." + u, a = null, c = [], l = {
        ...
        formatMoney: function(e, t) {
            return e < 0 && t.format.replace("%2$s", "-%2$s"),
            t.format.replace("%1$s", t.symbol).replace("%2$s", l.formatNumber(Math.abs(e), t.decimals || 0, t.thousand, t.decimal))
        }
    }, d = {
        init: function(e) {
        ...
        doLogic: function(n) {
            o("[data-dependencies]").each(function(e, t) {
                ...
                d.canShow(a) ? (r.removeClass(u + "hide"),
                a.prop("required", a.data("is-required")).prop("disabled", !1)) : (r.addClass(u + "hide"),
                n || l.setFieldValue(a, c[a.data("field-id")]),
                a.prop("required", !1).prop("disabled", !0))
            })
        },
        canShow: function(e) {
        ...
        validateGroup: function(e) {
            ...
            for (var t = 0; t < e.length; t++)
                if (!d.validRule(e[t].field, e[t].condition, e[t].value || ""))
                    return !1;
            return !0
        },
        validRule: function(e, t, a) {
            ...
            if (!r.length)
                return !1;
            if (r.closest(i + "field-container").hasClass(u + "hide"))
                return !1;
            var n = l.getFieldValue(r);
            switch ("number" == typeof n && (n = n.toString()),
            t) {
            case "check":
                return !0 === n;
            case "!check":
        ...
        calculate: function() {
            var e = window.wapf_config.display_options
              ...
              , r = "-total";
            o(i + "product" + r).html(l.formatMoney(t, e)),
            o(i + "options" + r).html(l.formatMoney(a, e)),
            o(i + "grand" + r).html(l.formatMoney(t + a, e)),
            o(i + "product" + r + "s").show()
        },
    ...
    s.init(),
    r.init(n),
    l.varsViaAjax() && jQuery(document).on("found_variation", function(e, t) {
        jQuery(document).trigger("wapf-ajax-variation", [t]),
        a = t,
        r.calculate()
    }),
    ...
    o(i + "checkable input").on("change", function() {
        var e = o(this);
        e.is(":radio") && e.closest(i + "field-input").find(i + "checkable").removeClass(u + "checked"),
        o(this).closest(i + "checkable").toggleClass(u + "checked")
    })
};
!function(e) {
    _wapf(e)
