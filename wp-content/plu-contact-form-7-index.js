!function() {
    ...
    const e = e=>Math.abs(parseInt(e, 10))
      , t = (e,t)=>{
        const r = new Map([["init", "init"], ["validation_failed", "invalid"], ["acceptance_missing", "unaccepted"], ["spam", "spam"], ["aborted", "aborted"], ["mail_sent", "sent"], ["mail_failed", "failed"], ["submitting", "submitting"], ["resetting", "resetting"], ["payment_required", "payment-required"]]);
        r.has(t) && (t = r.get(t)),
        Array.from(r.values()).includes(t) || (t = `custom-${t = (t = t.replace(/[^0-9a-z]+/i, " ").trim()).replace(/\s+/, "-")}`);
      ...
      , n = e=>{
        ...
        return a.reduceRight(((e,t)=>r=>t(r, e)), (e=>{
            ...
            "string" == typeof o && (n = r.replace(/^\/|\/$/g, ""),
            a = o.replace(/^\//, ""),
            s = a ? n + "/" + a : n),
            "string" == typeof s && (-1 !== t.indexOf("?") && (s = s.replace("?", "&")),
            s = s.replace(/^\//, ""),
            c = t + s),
            i = {
    ...
    function c(e) {
        ...
        n({
            ...
            o.apiResponse = n,
            ["invalid", "unaccepted", "spam", "aborted"].includes(a) ? r(e, a, o) : ["sent", "failed"].includes(a) && r(e, `mail${a}`, o),
            r(e, "submit", o),
            n
        }
        )).then((t=>{
      ...
      , l = (e,t)=>{
        for (const r in t) {
            ...
            e.querySelectorAll(`.wpcf7-form-control-wrap.${r}`).forEach((e=>{
                ...
                e.querySelector(`input[name="_wpcf7_quiz_answer_${r}"]`).value = a
            }
            ))
        }
    }
        ...
        (e=>{
            e.querySelectorAll(".wpcf7-validates-as-url").forEach((e=>{
                e.addEventListener("change", (t=>{
                    let r = e.value.trim();
                    r && !r.match(/^[a-z][a-z0-9.+-]*:/i) && -1 !== r.indexOf(".") && (r = r.replace(/^\/+/, ""),
                    r = "http://" + r),
                    e.value = r
                }
                ))
            ...
            const r = (t,r)=>{
              ...
              , n = e=>{
                ...
                t.querySelectorAll(".wpcf7-character-count").forEach((n=>{
                    ...
                    r(n, c),
                    e.init && c.addEventListener("keyup", (e=>{
                        r(n, c)
                    }
                    )))
                }
