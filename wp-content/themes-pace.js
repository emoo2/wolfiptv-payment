(function() {
    var t, e, n, r, s, o, i, a, u, c, l, p, h, f, d, g, m, y, v, w, b, S, k, q, x, L, T, P, R, j, E, M, O, A, N, _, F, C, U, H, X, W, D, I, z, B, G, J, K, Q = [].slice, V = {}.hasOwnProperty, Y = function(t, e) {
        function n() {
            this.constructor = t
        }
        for (var r in e)
    ...
    S = function() {
        ...
        i = r.length; o < i; o++)
            if (n = r[o])
                for (t in n)
                    V.call(n, t) && (s = n[t],
                    null != e[t] && "object" == typeof e[t] && null != s && "object" == typeof s ? S(e[t], s) : e[t] = s);
        return e
    }
    ,
    m = function(t) {
    ...
    e = function() {
        ...
        return t.prototype.getElement = function() {
            ...
            if (null == this.el) {
                ...
                this.el.innerHTML = '<div class="pace-progress"><div class="pace-progress-inner"></div>\n</div>\n<div class="pace-activity"></div>';
                var e = document.getElementById("ltx-preloader");
                e && (this.el.innerHTML += '<div class="ltx-theme-loader"><div class="ltx-glitch" data-text="' + e.dataset.loader + '">' + e.dataset.loader + "</div></div>"),
        ...
        function e() {
            ...
            if (null != H && j.ajax.trackWebSockets) {
                window.WebSocket = function(t, e) {
                    var r;
                    return r = null != e ? new H(t,e) : new H(t),
    ...
    h = function() {
        ...
        return t.prototype.tick = function(t, e) {
            var n;
            return null == e && (e = M(this.source, "progress")),
            e >= 100 && (this.done = !0),
